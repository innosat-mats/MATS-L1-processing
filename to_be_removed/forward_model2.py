...
class SimageItem(object):
    ...
    def bin_image_using_predict(self):
        from L1_calibration_functions import bin_image_using_predict
        binned_image, header=bin_image_using_predict(self.CCDitem)
        #self.CCDitem=header
        self.simage=binned_image
        
        
#Remove bias and BC correction here before adding smear?
    ...
    def remove_bias(self):
        from L1_calibration_functions import get_true_image
        self.simage=get_true_image(self.CCDitem.copy(),self.simage.copy())
...
mySimageItem.bin_image_using_predict()
mySimageItem.remove_bias()
