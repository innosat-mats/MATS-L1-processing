...
def extract_racfile(directory, racfile):
    ...
    for j in range(0, 7):
        ...
        for x in range(0, len(AllDataSorted)):
            if AllDataSorted[x]["Source_data"]["SID_mnemonic"] == [
                "CCD data channel " + str(j + 1)
            ]:

                # go through all packets in that image and put image data and meta data into structures
                if (
                    AllDataSorted[x]["SPH_grouping_flags"] == "01"
                    or AllDataSorted[x]["SPH_grouping_flags"] == "11"
                ):
                    ...
                    # Add data to image
                    CCD_image_data["channel " + str(j + 1)][n]["data"].append(
                        AllDataSorted[x]["Source_data"]["IMG"]
                    )

                    CCD_meta_data["channel " + str(j + 1)].append({})

                    CCD_meta_data["channel " + str(j + 1)][n][
                        "SID_mnemonic"
                    ] = AllDataSorted[x]["Source_data"]["SID_mnemonic"]
                    CCD_meta_data["channel " + str(j + 1)][n]["CCDSEL"] = AllDataSorted[
                        x
                    ]["Source_data"]["CCDSEL"]
                    CCD_meta_data["channel " + str(j + 1)][n]["EXPTS"] = AllDataSorted[
                        x
                    ]["Source_data"]["EXPTS"]
                    CCD_meta_data["channel " + str(j + 1)][n]["EXPTSS"] = AllDataSorted[
                        x
                    ]["Source_data"]["EXPTSS"]
                    CCD_meta_data["channel " + str(j + 1)][n]["WDW"] = AllDataSorted[x][
                        "Source_data"
                    ]["WDW"]
                    CCD_meta_data["channel " + str(j + 1)][n]["WDWOV"] = AllDataSorted[
                        x
                    ]["Source_data"]["WDWOV"]
                    CCD_meta_data["channel " + str(j + 1)][n]["JPEGQ"] = AllDataSorted[
                        x
                    ]["Source_data"]["JPEGQ"]
                    CCD_meta_data["channel " + str(j + 1)][n]["FRAME"] = AllDataSorted[
                        x
                    ]["Source_data"]["FRAME"]
                    CCD_meta_data["channel " + str(j + 1)][n]["NROW"] = AllDataSorted[
                        x
                    ]["Source_data"]["NROW"]
                    CCD_meta_data["channel " + str(j + 1)][n]["NRBIN"] = AllDataSorted[
                        x
                    ]["Source_data"]["NRBIN"]
                    CCD_meta_data["channel " + str(j + 1)][n]["NRSKIP"] = AllDataSorted[
                        x
                    ]["Source_data"]["NRSKIP"]
                    CCD_meta_data["channel " + str(j + 1)][n]["NCOL"] = AllDataSorted[
                        x
                    ]["Source_data"]["NCOL"]
                    CCD_meta_data["channel " + str(j + 1)][n]["NCBIN"] = AllDataSorted[
                        x
                    ]["Source_data"]["NCBIN"]
                    CCD_meta_data["channel " + str(j + 1)][n]["NROW"] = AllDataSorted[
                        x
                    ...
                    CCD_meta_data["channel " + str(j + 1)][n]["NCSKIP"] = AllDataSorted[
                        x
                    ]["Source_data"]["NCSKIP"]
                    CCD_meta_data["channel " + str(j + 1)][n]["NFLUSH"] = AllDataSorted[
                        x
                    ]["Source_data"]["NFLUSH"]
                    CCD_meta_data["channel " + str(j + 1)][n]["TEXPMS"] = AllDataSorted[
                        x
                    ]["Source_data"]["TEXPMS"]
                    CCD_meta_data["channel " + str(j + 1)][n]["GAIN"] = AllDataSorted[
                        x
                    ]["Source_data"]["GAIN"]
                    CCD_meta_data["channel " + str(j + 1)][n]["TEMP"] = AllDataSorted[
                        x
                    ]["Source_data"]["TEMP"]
                    CCD_meta_data["channel " + str(j + 1)][n]["FBINOV"] = AllDataSorted[
                        x
                    ]["Source_data"]["FBINOV"]
                    CCD_meta_data["channel " + str(j + 1)][n]["LBLNK"] = AllDataSorted[
                        x
                    ]["Source_data"]["LBLNK"]
                    CCD_meta_data["channel " + str(j + 1)][n]["TBLNK"] = AllDataSorted[
                        x
                    ]["Source_data"]["TBLNK"]
                    CCD_meta_data["channel " + str(j + 1)][n]["ZERO"] = AllDataSorted[
                        x
                    ]["Source_data"]["ZERO"]
                    CCD_meta_data["channel " + str(j + 1)][n][
                        "TIMING1"
                    ] = AllDataSorted[x]["Source_data"]["TIMING1"]
                    CCD_meta_data["channel " + str(j + 1)][n][
                        "TIMING2"
                    ] = AllDataSorted[x]["Source_data"]["TIMING2"]
                    CCD_meta_data["channel " + str(j + 1)][n][
                        "VERSION"
                    ] = AllDataSorted[x]["Source_data"]["VERSION"]
                    CCD_meta_data["channel " + str(j + 1)][n][
                        "TIMING3"
                    ] = AllDataSorted[x]["Source_data"]["TIMING3"]
                    CCD_meta_data["channel " + str(j + 1)][n]["NBC"] = AllDataSorted[x][
                        "Source_data"
                    ]["NBC"]
                    CCD_meta_data["channel " + str(j + 1)][n]["BC"] = AllDataSorted[x][
                        "Source_data"
                    ]["BC"]
                    ...
                    if not CCD_image_data["channel " + str(j + 1)]:
                        print(
                            "Warning: current .rac file started with continued CCD data for this channel"
                        )
        ...
        for x in range(0, len(CCD_image_data["channel " + str(j + 1)])):
            ...
            if (
                CCD_image_data["channel " + str(j + 1)][x].get("start") != None
                and CCD_image_data["channel " + str(j + 1)][x].get("stop") != None
            ):
                if (
                    CCD_image_data["channel " + str(j + 1)][x]["start"]
                    and CCD_image_data["channel " + str(j + 1)][x]["stop"]
                ):
                    a = "".join(CCD_image_data["channel " + str(j + 1)][x]["data"])
                    CCD_image_data["channel " + str(j + 1)][x][
                        "image"
                    ] = binascii.unhexlify(a)
                    CCD_image_data["channel " + str(j + 1)][x]["error"] = 0
                else:
                    print(
                        "Warning: start or stop does not exist for image: "
                        + str(x)
                        + ", channel "
                        + str(j + 1)
                    )
                ...
                print(
                    "Warning: start or stop key does not exist for image: "
                    + str(x)
                    + ", channel "
                    + str(j + 1)
                )
    ...
    for j in range(0, 7):  # loop over channels again
        for i in range(len(CCD_image_data["channel " + str(j + 1)])):
            ...
            if CCD_image_data["channel " + str(j + 1)][i].get("error") == 0:
                ...
                with open(filename, "w") as outfile:
                    json.dump(
                        CCD_meta_data["channel " + str(j + 1)][i],
                        outfile,
                        sort_keys=True,
                        indent=4,
                        ensure_ascii=False,
