...
=======
def read_all_files_in_directory(read_from, directory):
    """Reads in directory of files generated by molflow rac reader and returns a list of CCD items"""
    if read_from == "rac":
        CCDitems = read_CCDitems(directory)
>>>>>>> 1713866c6b1f86affd7c39fbea73ebe4592fc16f
    else:
...
=======
        ...
        item["Image File Name"] = (
            item["File"][2:-4] + "_" + str(item["EXP Nanoseconds"]) + ".png"
        )
        pngfile = rac_dir + str(item["Image File Name"])
        jsonfile = pngfile[0:-4] + ".json"
>>>>>>> 1713866c6b1f86affd7c39fbea73ebe4592fc16f
