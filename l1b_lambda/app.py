...
if development:
    ...
    input_bucket_name_ccd = "ops-payload-level1a-v0.7"
    output_bucket_name_ccd = "ops-payload-level1b-v0.6"
    input_bucket_name_pm = "ops-payload-level1a-pm-v0.4"
    output_bucket_name_pm = "ops-payload-level1b-pm-v0.2"
