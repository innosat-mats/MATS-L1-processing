...
image, header = readimgpath('/home/franzk/Documents/MATS/L1_processing/data/2019-02-08 rand6/', image_index, 0)
...
print('Leading blank: '+str(header['BlankLeadingValue'])+', Trailing blank: '+str(header['BlankTrailingValue']))
